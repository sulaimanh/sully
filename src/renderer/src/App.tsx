...
export default function App(): ReactElement {
  ...
  return (
    <div className="atmosphere flex h-full">
      ...
      >
        {/* traffic lights sit at (18,18); keep this whole strip clear of text
            and place the wordmark on its own row below them. While collapsed,
            drop the drag region: dragging swallows the hover events the
            hover-expand behavior depends on */}
        <div className={cn('h-[44px] shrink-0', !sidebarCollapsed && 'titlebar-drag')} />
        <div
          className={cn(
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <div className="titlebar-drag flex h-[52px] shrink-0 items-center justify-end gap-3 px-7">
          <UsageBar />
          <button
            onClick={() => {
